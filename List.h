...
long front(List L);						//Returns front element of List L.
										//Precondition: length() > 0
long back(List L);						//Returns back element of List L.
										//Precondition: length() > 0
long get(List L);						//Returns cursor element of List L.
										//Precondition: length() > 0 & index() >= 0
int equal(List A, List B);				//Returns true if and only if Lists A and B are in the same state,
...
void prepend(List L, long data);		//Insert new element into List L. If L is non-empty, insertion takes
										//place before front element.
void append(List L, long data);			//Insert new element into List L. If L is non-empty, insertion takes
